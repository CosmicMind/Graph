...
//  Graph
//
//  Created by Orkhan Alikhanov on 8/22/18.
...
private extension ApiTests {
  ...
  func assertSearch(_ predicate: Predicate, _ count: Int, file: StaticString = #file, line: UInt = #line) {
    ...
    let testExpectation1 = expectation(description: "[EntitySearchTests Error: Test failed.]")
    ...
    let testExpectation2 = expectation(description: "[EntitySearchTests Error: Test failed.]")
